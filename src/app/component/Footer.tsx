const Github = () => {
    return (
        <a href="https://github.com/osuquest" target={"_blank"} className={"fill-slate-400"}>
    ...
    return (
        <footer className="footer absolute mb-3 bottom-0.5 w-full text-center">
            <div
                ...
                <Github/> <p>&copy; osu!quest | osu.quest {year}</p>
            </div>
        </footer>
    );
};
...
// path: osu.quest/src/app/container/footer/Footer.tsx
